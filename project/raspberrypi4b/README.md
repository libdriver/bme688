...
bme688: SPI interface SCK connected to GPIO11(BCM).
bme688: SPI interface MISO connected to GPIO9(BCM).
bme688: SPI interface MOSI connected to GPIO10(BCM).
bme688: SPI interface CS connected to GPIO8(BCM).
bme688: IIC interface SCL connected to GPIO3(BCM).
bme688: IIC interface SDA connected to GPIO2(BCM).
```
